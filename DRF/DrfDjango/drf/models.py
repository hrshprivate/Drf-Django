...
class Recipe(models.Model):
    ...
    name = models.CharField('Название', null=True, blank=False, max_length=120)
    dis = models.TextField('Desc:', blank=False)
    tag = models.ManyToManyField(Tag, related_name="tag", blank=True)
    time = models.IntegerField('Время', null=True, blank=False)
    image = ResizedImageField(size=[500, 300], quality=100, upload_to=get_image_path, verbose_name='Картинка', default='pictures/def.jpg')
...
class Photo(models.Model):
    ...
    image1 = ResizedImageField(size=[500, 300], quality=100, upload_to=get_image_path, verbose_name='Картинка',
                              default='pictures/def.jpg')
    disk = models.CharField('ID-DISK', null=True, blank=False, max_length=120)
    name_of_user = models.CharField('username', null=True, blank=False, max_length=120)
    date = models.DateTimeField(auto_now=True, blank=True)

    def __str__(self):
         return f'{self.image1} сравниваем с neiro_image'
